...
class AMATestSuite:
    ...
    def test_02_qodeia_engines(self):
        ...
        engines = [
            ...
            (
                "Cognitive-Brain",
                "qodeia_engines.cognitive_brain",
                "CognitiveBrainEngine",
            ),
            (
                "Associative-Memory",
                "qodeia_engines.associative_memory",
            ...
            (
                "Adaptive-Pruning",
                "qodeia_engines.adaptive_pruning",
    ...
    def test_03_individual_engines(self):
        ...
        # Test AMA-G
        result = bus.call(
            "AMA-G", {"text": "Test de gobernanza", "requires_text": True}
        )
    ...
    def test_06_semantic_search(self):
        ...
        docs = [
            {
                "id": "doc1",
                "text": "Gobernanza y seguridad con AMA-G",
                "meta": {"topic": "governance"},
            },
            {
                "id": "doc2",
                "text": "Búsqueda semántica con TF-IDF",
                "meta": {"topic": "search"},
            },
            {
                "id": "doc3",
                "text": "Métricas de calidad con LFPI",
                "meta": {"topic": "metrics"},
            },
            {
                "id": "doc4",
                "text": "Working memory en Cognitive-Brain",
                "meta": {"topic": "cognition"},
            },
            {
                "id": "doc5",
                "text": "Consolidación nocturna automática",
                "meta": {"topic": "memory"},
            },
        ]
    ...
    def test_08_metrics_dashboard(self):
        ...
        print(
            f"  ✓ Distribution: excellent={dist['excellent']}, good={dist['good']}, fair={dist['fair']}, poor={dist['poor']}"
        )
    ...
    def test_10_performance(self):
        ...
        # Ingest
        docs = [
            {"id": f"d{i}", "text": f"Documento {i}", "meta": {}} for i in range(100)
        ]
    ...
    def test_06_rocketml_rml(self):
        ...
        # Test Inferencia
        res = engine.run(
            {"op": "inference", "embedding": np.random.randn(128).tolist()}
        )
