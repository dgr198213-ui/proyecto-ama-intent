...
def jwt_manager():
    ...
    return SDDCSJWTManager(
        secret_key="test-secret",
        network_salt="Test-JWT-Salt"
    )
...
class TestAgentStateSync:
    ...
    def test_checkpoint_validation_corrupted_state(self, agent_sync, sample_agent_state):
    ...
    def test_checkpoint_validation_corrupted_checkpoint(self, agent_sync, sample_agent_state):
        ...
        is_valid = agent_sync.validate_checkpoint(bytes(corrupted_checkpoint), sample_agent_state)
...
class TestContextCacheValidation:
    ...
    def test_cache_validation_corrupted(self, cache_validator):
        ...
        is_valid, message = cache_validator.validate_cached_context(corrupted_context, fingerprint)
    ...
    def test_cache_validation_truncated(self, cache_validator):
        ...
        is_valid, message = cache_validator.validate_cached_context(truncated_context, fingerprint)
...
class TestPluginStatePersistence:
    ...
    def test_load_state_corrupted(self, sddcs_plugin):
        ...
        new_plugin = SDDCSPlugin("test_plugin")
        is_valid, message = new_plugin.load_state_with_validation(corrupted_bytes, fingerprint)
