...
class AMAMetrics:
    ...
    def __init__(self):
        ...
        self.sddcs_checkpoints_created_total = Counter(
            'sddcs_checkpoints_created_total',
            'Total SDDCS checkpoints created'
        )
        
        self.sddcs_checkpoints_validated_total = Counter(
            'sddcs_checkpoints_validated_total',
            'Total SDDCS checkpoints validated'
        )
        
        self.sddcs_validation_failures_total = Counter(
            'sddcs_validation_failures_total',
            'Total SDDCS validation failures'
        )
        
        self.sddcs_validation_success_rate = Gauge(
            'sddcs_validation_success_rate',
            'SDDCS validation success rate (0-1)'
        )
        ...
        self.sddcs_cache_validations_total = Counter(
            'sddcs_cache_validations_total',
            'Total SDDCS cache validations'
        )
        
        self.sddcs_jwt_rolling_refreshes_total = Counter(
            'sddcs_jwt_rolling_refreshes_total',
            'Total JWT rolling seed refreshes'
        )
        ...
        self.agent_current_step = Gauge(
            'agent_current_step',
            'Current step of running agent'
        )
        
        self.agent_total_steps = Gauge(
            'agent_total_steps',
            'Total steps in agent task'
        )
