...
class BugInjector:
    ...
    def _inject_eval_bug(self, code: str) -> BugPattern:
        ...
        return BugPattern(
            ...
            code,
            buggy,
            "Uso de eval() con input no sanitizado",
            "critical",
        )
    ...
    def _inject_sql_injection(self, code: str) -> BugPattern:
        ...
        return BugPattern(
            ...
            code,
            buggy,
            "Concatenación de strings en query SQL",
            "critical",
        )
    ...
    def _inject_nested_loops(self, code: str) -> BugPattern:
        ...
        return BugPattern(
            ...
            code,
            buggy,
            "Bucle anidado O(n^2) innecesario",
            "medium",
        )
    ...
    def _inject_off_by_one(self, code: str) -> BugPattern:
        ...
        return BugPattern(
            BugType.LOGIC, code, buggy, "Error de índice off-by-one en slicing", "high"
        )
    ...
    def _inject_file_leak(self, code: str) -> BugPattern:
        ...
        return BugPattern(
            BugType.RESOURCE_LEAK, code, buggy, "Archivo abierto sin cerrar", "medium"
        )
...
class AgenticDataSynthesizer:
    ...
    def convert_to_preference_pairs(
