...
async def endpoint_query(
    orchestrator: KnowledgeGraphOrchestrator, payload: Dict[str, Any]
):
...
async def endpoint_refactoring_suggestions(
    orchestrator: KnowledgeGraphOrchestrator, payload: Dict[str, Any]
):
